 ...
 * File: WordleGUI.java
 * ------------------------
 * This file implements the WordleGUI class, which manages the
...
public class WordleGUI {
    ...
    /**
     * Creates a new WordleGUI object and displays it on the screen.
     */
     ...
     *
     * @param listener The EventListenter waiting for this event
     */

    public void addEnterListener(EventListener listener) {
...
class WordleCanvas extends JComponent implements KeyListener, MouseListener {
    ...
    public static final int N_ROWS = WordleGUI.N_ROWS;
    public static final int N_COLS = WordleGUI.N_COLS;

    public static final Color CORRECT_COLOR = WordleGUI.CORRECT_COLOR;
    public static final Color PRESENT_COLOR = WordleGUI.PRESENT_COLOR;
    public static final Color MISSING_COLOR = WordleGUI.MISSING_COLOR;
...
interface EventListener {
    // This function defines EventListener as a functional interface
